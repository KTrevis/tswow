...
import { createKillingQuest } from "../Utils/KillingQuest";
...
const quest = createKillingQuest(name, std.CreatureTemplates.load(197), [{id: mob.ID, quantity: 1}], 4)
...
quest.POIs.get()[0].WorldMapArea.set(30)