...
export class SpellEffectType extends EnumCellTransform<SpellEffect> {
    ...
    /** Enum Value:                                         112 */
    get TOGGLE_GUARDIAN()               { return this.value(112, x=>new ToggleGuardian(x)) }
    /** Enum Value:                                         113 */
